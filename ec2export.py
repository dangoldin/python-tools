...
# From https://github.com/Ramzi-Alqrainy/ec2export2csv/blob/master/ec2export.py
...
def write_instances(instance):
  ...
  csv_file.write("%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s\n"%(instance.id,instance.tags.get('Name',''),environment,instance.private_ip_address, instance.public_dns_name,
